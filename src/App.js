    ...
    <div className='App'>
            ...
            <div class='details'>
              ...
              <div>
                <ul>
                  ...
                  <li>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Proin nec mi ante. Etiam odio eros, placerat eu metus id,
                    gravida eleifend odio. Vestibulum dapibus pharetra odio,
                    egestas ullamcorper ipsum congue ac. Maecenas viverra tortor
                    eget convallis vestibulum. Donec pulvinar venenatis est, non
              ...
              <div>
                <ul>
                  ...
                  <li>
                    ...
                    Proin nec mi ante. Etiam odio eros, placerat eu metus id,
                    gravida eleifend odio. Vestibulum dapibus pharetra odio,
                    egestas ullamcorper ipsum congue ac
                  </li>
                  <li>
                    Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                    Proin nec mi ante. Etiam odio eros, placerat eu metus id,
            ...
            <div class='details'>
              ...
              <div class='concise'>
                <ul>
                  ...
                  <li>
                    Recursive research and its impact on recursive research
                  </li>
      ...
      <aside id='sidebar'>
        ...
        <div class='side-block' id='disclaimer'>
          This r&eacute;sum&eacute; was wholly typeset with HTML/CSS &mdash; see{' '}
          <code>git.io/vVSYL</code>
        </div>
      </aside>
    </div>
  );
